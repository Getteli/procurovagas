...
@section('content')
	...
	<div class="container cardstyle mt-5 mb-5">
		...
		<div class="container p-5 justify">
			<h2 class="subtitle">
				Segue abaixo nossa Política de privacidade
			</h2>
 			<p>A sua privacidade é importante para nós. É política do Procuro Vagas respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=https://procurovagas.com.br>Procuro Vagas</a>, e outros sites que possuímos e operamos.</p>
			...
			<h2>Política de Cookies Procuro Vagas</h2>
			...
			<p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Procuro Vagas oferece no site e com caráter enunciativo, mas não limitativo:</p>
			<ul>
				...
				<li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Procuro Vagas, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
			</ul>
